...
export default function SocialLogin() {
	return (
		<div className="space-y-4 mb-8">
			{/* Google Button */}
			<button className="w-full group relative cursor-pointer overflow-hidden flex items-center justify-center gap-3 bg-white text-gray-900 font-semibold py-3.5 px-4 rounded-xl transition-all duration-300 hover:shadow-2xl hover:shadow-purple-500/20 hover:-translate-y-0.5 active:translate-y-0">
